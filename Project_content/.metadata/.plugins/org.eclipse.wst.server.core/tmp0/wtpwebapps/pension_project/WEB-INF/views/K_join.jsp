...
<title>인덱스</title>
  <style>
        ...
        .join_info{clear: both; width: 1280px; margin: 0 auto;}
        .text{margin-top: 20px; margin-bottom: 20px; font-size: 24px; font-weight: bold;}
        #info_btn{font-size: 16px; font-weight: bold;}
        input{font-size: 16px; font-weight: bold;}
        .btn{clear: both; width: 1280px; margin: 0 auto;padding-left: 490px; }
        button{width: 200px; height: 50px; border-radius: 4px; font-size: 16px; font-weight: bold; margin-bottom:20px ; margin-right: 20px;}
...
<%@ include file = "header.jsp" %>
  <main class="content con">
            ...
            <section class="join_info">
                <ul class="list">
                    <p class="text">개인정보수집동의</p>
                    <textarea name="" id="text1" cols="200" rows="15">
제 1장 총칙
...
부 칙 1. (시행일) 본 약관은 2016년 1월 1일부터 시행됩니다.
                    ...
                    <div class="box">
                        <input type="checkbox" id="info_btn" name="agree" value="">동의함</input>
                        <input type="checkbox" id="n_info_btn" name="n_info_btn" value="">동의안함</input>
                    </div>
                    
                </ul>
                <ul class="list2">
                    <p class="text">이용약관동의</p>
                    <textarea name="" id="text2" cols="200" rows="15" readonly>
가. 개인정보의 수집 및 이용 목적
...
위 개인정보의 수집 및 이용에 대한 동의를 거부할 수 있으나, 동의를 거부할 경우 회원 가입이 제한됩니다.
                ...
                <div class="btn">
                    <button type="button" id="next_btn" name="next_btn"><a href="javascript:agree();">다음</a></button>
                    <button type="button" id="main_btn" name="main_btn"><a href="">메인으로</a></button>
                </div>
            </section>
        </main>
