	...
	<div class="main_table">
		...
		<form action="">
			<table>
				<tr>
					<th>아이디</th>
					<td><input type="text" placeholder="m_id"/></td>
				</tr>
				<tr>
					<th>비밀번호</th>
					<td><input type="text" placeholder="m_pw"/></td>
				</tr>
				<tr>
					<th>성명</th>
					<td><input type="text" placeholder="m_name"/></td>
				</tr>
				<tr>
					<th>이메일</th>
					<td><input type="text" placeholder="m_email"/></td>
					
				</tr>
				<tr>
					<th>주소</th>
					<td><input type="number" placeholder="m_addr"/></td>
				</tr>
				<tr>
					<th>핸드폰</th>
					<td><input type="number" placeholder="m_phone"/></td>
				</tr>
				<tr>
					<th>등급</th>
					<td><input type="number" placeholder="m_grade"/></td>
				</tr>
				<tr>
					<th>포인트</th>
					<td><input type="number" placeholder="m_point"/></td>
				</tr>
				<tr>
