                ...
                <div class="room_info_box">
                    ...
                    <div class="room_box">
                        <div class="room_desc_box">
                            <p class="room_desc_tit">객실형태</p>
                            <p class="room_desc_con">거실+복층,취사시설,침대1,화장실1</p>
                            <p class="room_desc_tit">객실평수</p>
                            <p class="room_desc_con">15평</p>
                            <p class="room_desc_tit">구비시설</p>
                            <p class="room_desc_con">인덕션,전자레인지,냉장고,드라이기,에어프라이어</p>
