	...
	<div class="main_table">
		...
		<form action="">
			<table>
				<tr>
					<th>방번호</th>
					<td><input type="text" placeholder="방번호" value="${roomDetailAD.r_number }" readonly/></td>
				</tr>
				<tr>
					<th>방이름</th>
					<td><input type="text" placeholder="방이름" value="${roomDetailAD.r_name }"/></td>
				</tr>
				<tr>
					<th>가격</th>
					<td><input type="text" placeholder="가격" value="${roomDetailAD.r_price }"/></td>
				</tr>
				<tr>
					<th>설명</th>
					<td><textarea rows="20" cols="30" style= "resize : none;" placeholder="방설명"><c:out value="${roomDetailAD.r_description }"/></textarea></td>
				</tr>
				<tr>
					<th>인원</th>
					<td><input type="text" placeholder="인원" value="${roomDetailAD.r_guestsnum }"/></td>
				</tr>
				<tr>
