	...
	<div class="main_table">
		...
		<form action="">
			<table>
				<tr>
					<th>예약번호</th>
					<td><input type="text" placeholder="re_number"/></td>
				</tr>
				<tr>
					<th>입실~퇴실</th>
					<td><input type="text" placeholder="checkin+checkout"/></td>
				</tr>
				<tr>
					<th>방번호</th>
					<td><input type="text" placeholder="r_num"/></td>
				</tr>
				<tr>
					<th>인원수</th>
					<td><input type="text" placeholder="p_number"/></td>
				...
				<tr>
					<td colspan="2"	style="text-align: center; border-top: 1px solid #333;">
						...
						<input type="button" value="취소" onclick="location.href='reservation_manager.jsp'"/>
