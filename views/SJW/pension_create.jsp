	...
	<div class="main_table">
		...
		<form action="">
			<table>
				...
				<tr>
					<th>설명</th>
					<td><textarea rows="20" cols="40" style= "resize : none;"></textarea></td>
				...
				<tr>
					<td colspan="2"
						...
						type="reset" value="초기화" /> <input type="button" value="취소" onclick="location.href='pension_manager.jsp'"/> <input
